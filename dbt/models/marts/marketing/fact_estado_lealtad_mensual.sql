...
from lealtad l
left join {{ ref('dim_cliente') }} dc_hist on l.id_cliente_nk = dc_hist.id_cliente_nk 
...
left join {{ ref('dim_cliente') }} dc_curr on l.id_cliente_nk = dc_curr.id_cliente_nk and dc_curr.es_actual = true