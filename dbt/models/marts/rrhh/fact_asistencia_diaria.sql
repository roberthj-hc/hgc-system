...
left join {{ ref('dim_empleado') }} de_hist on a.id_empleado_nk = de_hist.id_empleado_nk 
...
left join {{ ref('dim_empleado') }} de_curr on a.id_empleado_nk = de_curr.id_empleado_nk and de_curr.es_actual = true
