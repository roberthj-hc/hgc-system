...
export function ProfitDetectiveDescription() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <SmartButtons module="Detective de Rentabilidad" data={{ sucursalSeleccionada: selectedBranch, ingresoBruto: mainData?.ingreso_bruto, utilidadNeta: mainData?.utilidad_neta, factorTiempo: mainData?.factor_tiempo }} />
