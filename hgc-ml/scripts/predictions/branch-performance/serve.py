"""
serve_branch_performance.py — Servidor MLflow Caso 3: Branch Performance (Puerto 5010)
...
MODEL_PORT = int(os.getenv("MLFLOW_BRANCH_PORT", 5010))

HGC_ML_DIR = Path(__file__).resolve().parent.parent.parent.parent
MODEL_PATH  = HGC_ML_DIR / "mlruns" / "5" / "models" / "m-740c5b92c5314b21a82f2ab0b3a3a63c" / "artifacts"
...
def serve_model():
    print(f"\n Iniciando servidor Branch Performance...")
    ...
    try:
        ...
        print("\n Servidor Branch Performance detenido.")
...
if __name__ == "__main__":
    print("=" * 55)
    print("  CASO 3 — Branch Performance · MLflow Model Server")
    print("=" * 55)
    serve_model()
