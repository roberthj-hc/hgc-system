"""
serve_cannibalization.py
────────────────────────────────────────────
Servidor MLflow para el modelo Caso 5 — Cannibalization Prediction.

El modelo registrado 'HGC_Cannibalization_Model_Pro' se sirve aquí en el puerto 5006.
"""
...
MODEL_PORT           = int(os.getenv("MLFLOW_CANNIBALIZATION_PORT", 5006))

def serve_model():
    """Lanza el servidor MLflow en el puerto configurado usando el modelo registrado."""
    model_uri = "models:/HGC_Cannibalization_Model_Pro/latest"

    print(f"\n Iniciando servidor Cannibalization...")
    ...
    try:
        ...
        print("\n Servidor Cannibalization detenido.")
    except subprocess.CalledProcessError as e:
        print(f"\n Error al iniciar el servidor Cannibalization: {e}")
        sys.exit(1)


if __name__ == "__main__":
    print("=" * 55)
    print("  CASO 5 — Cannibalization · MLflow Model Server")
    print("=" * 55)
    serve_model()
