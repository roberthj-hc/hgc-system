...
try:
    ...
    try: 
        ...
        df = pd.DataFrame({
            ...
            'FEATURE_FRECUENCIA_HISTORICA': np.random.randint(1, 50, n),
            'FEATURE_MONTO_GASTO_HISTORICO': np.random.uniform(50, 5000, n),
            'FEATURE_RECENCIA_DIAS': np.random.randint(1, 365, n),
            'TARGET_ES_CHURN': np.random.randint(0, 2, n)
        })
